...
public class ShaderProgram {
	...
	public void updateUniformVar(GL2 gl, int variable, float value) {
		assert(variable != -1);
		gl.glUniform1f(variable, value);
	}
	
	public void updateUniformVar(GL2 gl, int variable, Vector2f value) {
		assert(variable != -1);
		gl.glUniform2fv(variable, 1, VerticeVec.toBuffer(value));
	}
