...
class Quad {
	...
	Quad(Vector2f leftTop, Vector2f size){

		SVertexP2T2 vLeftTop = new SVertexP2T2(leftTop, new Vector2f(0, 0));
		SVertexP2T2 vRightTop = new SVertexP2T2(VecUtils.sum(leftTop, new Vector2f(size.x, 0.f)), new Vector2f(MAX_TEX_COORD, 0));
		SVertexP2T2 vLeftBottom = new SVertexP2T2(VecUtils.sum(leftTop, new Vector2f(0.f, size.y)), new Vector2f(0, MAX_TEX_COORD));
		SVertexP2T2 vRightBottom = new SVertexP2T2(VecUtils.sum(leftTop, new Vector2f(size.x, size.y)), new Vector2f(MAX_TEX_COORD, MAX_TEX_COORD));
