...
public class Canvas extends GLCanvas implements GLEventListener {
    ...
    private SolidMoebiusStrips solidMoebiusStrip;
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        solidMoebiusStrip = new SolidMoebiusStrips(getMoebiusPoint);
       ...
       solidMoebiusStrip.tesselate(new Vector2f(-10.f, 10.f), new Vector2f(-10.f, 10.f), 0.07f);
    }
    ...
    private void initMaterial(GL2 gl){
        ...
        gl.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, MathVec4f.toBuffer(new Vector4f(1, 1, 0, 1)));
        gl.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, MathVec4f.toBuffer(new Vector4f(1, 1, 0, 1)));
        gl.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, MathVec4f.toBuffer(new Vector4f(0.3f, 0.3f, 0.3f, 1.f)));
